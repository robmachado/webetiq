...
class Takata extends LabelBase implements LabelsInterface
{
    ...
    /**
     * License Plate é a chave para a identificação única da 
     * unidade de transporte com espaços para leitura humana
     * @var string
     */
    ...
    /**
     * Número atribuído pelo fornecedor para corresponder com o número ASN
     * enviado para o cliente para a expedição.
     * @var string 
     */
    public static $asn = '4227123456';
    ...
    public function renderize()
    {
        for ($x=0; $x < self::$copies; $x++) {
            ...
            $template = str_replace('{asn}', self::$asn, $template);
    ...
    protected static function licPlate($seqnum, $lot)
    {
        ...
        self::$licplate = '' . str_pad(self::$supplier, 7, '0', STR_PAD_LEFT) . substr(str_pad($lot.$seqnumform, 9, '0', STR_PAD_LEFT), -9);
