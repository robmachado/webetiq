...
<?php
//carrega as variáveis a partir da base de dados
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF" width="700">
        <table border="0" cellpadding="0" width="700">
			...
			<input type="hidden" name="volumex" value="<?echo $volume;?>"> 
          ...
          <tr>
            ...
            <td width="552"><input type="text" name="opx" value="<?echo $op;?>" size="25"> Emissão <?echo $emissao;?></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="552"><input type="text" name="produtox" value ="<?echo $cod;?>" size="25"><?echo "Total = ".$tot_qtdade." ".$unidade." [ ".str_replace(".",",",$tot_peso)."kg ]"?></td>
          </tr>
          <tr>
            <td width="138" align="right">Descrição</td>
            <td width="552"><input type="text" name="descx" value ="<?echo $desc;?>" size="76"></td>
          </tr>
          <tr>
            <td width="138" align="right">EAN</td>
            <td width="552"><input type="text" name="eanx" size="25" value="<?echo $ean;?>"></td>
          </tr>
          <tr>
            <td width="138" align="right">Código Cliente</td>
            <td width="552"><input type="text" name="codclix" value ="<?echo $codcli;?>" size="25"></td>
          </tr>
          <tr>
            <td width="138" align="right">Pedido Interno</td>
            <td width="552"><input type="text" name="pedidox" value ="<?echo $pedido;?>" size="25"></td>
          </tr>
          <tr>
            <td width="138" align="right">Pedido Cliente</td>
            <td width="552"><input type="text" name="pedclix" value ="<?echo $pedcli;?>" size="25"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="552"><input type="text" name="volume" value ="<?echo $volume;?>" size="16" ></td>
          </tr>
	  <tr>
		...
		<input type="text" name="unidadex" value ="<?echo $unidade;?>" size="3">
          ...
          <tr>
            ...
            <? for( $x = 0; $x < count($aPrint); $x++){
                $selp[$x]='';
                if ($aPrint[$x][0] != ''){
                    if($aPrint[$x][0] == 'newZebra'){ //$remoteip
						$selp[$x]='selected';
                    }
                }
            ?>
...
<?//echo 'aqui !!! '.$numdias.'   '.$novavalidade;
